...
$totalRegistros = $expensesDao->countTotalExpensesUserCurrentMonth($userData->id);
            ...
            <form action="<?= $BASE_URL ?>expense_process.php" method="post">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="description" id="description" placeholder="Ex: salário" value="<?= $_SESSION['description'] ?>" required>
                    </div>
                    <div class="col-md-3">
                        ...
                        <ul class="pagination pagination-lg">
                            <?php for ($i = 1; $i <= $numberPages; $i++) : ?>
                                ...
                                <li class="page-item <?= $active ?>">
                                    <a class="page-link" href="<?= $BASE_URL ?>add_expenses.php?page=<?= $i ?>" tabindex="-1"><?= $i ?></a>
                                </li>
        ...
        <div class="modal-dialog modal-dialog-top" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Editar <?= $expense->description ?></h5>
                ...
                <div class="modal-body">
                    <form action="<?= $BASE_URL ?>expense_process.php?id=<?= $expense->id ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" id="" class="form-control" placeholder="Insira uma nova descrição" value="<?= $expense->description ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date_expense" id="date_expense" value="<?= date("Y-m-d", strtotime($expense->dt_expense)) ?>" required>
                        </div>
